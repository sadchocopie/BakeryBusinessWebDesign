...
//these are a sampling of random user agents
const user_agents = [
...
const ua_parsed = useragent.parse(user_agent);
//console.log(JSON.stringify(ua_parsed));
const browser = ua_parsed.family;
const device = ua_parsed.device.family;
