            ...
            <div class="container">
                <div class="row">
                    <div class="tewlve column login-form">
                        <form id="login-form" action="index.php" action="POST">
                            <div class="row">
                            ...
                            <label class="AdminDropdown">
                                <label for="selectAdmin">Log in as</label>
                                <select class="u-full-width" id="selectAdmin">
                                    <option value="Admin-option">Admin</option>
                                </select>
                            </label>

			                <button class="button-primary" id="login-button" type="submit" value="Submit" formmethod="post" formaction='index.php'>Submit</button>
                        </form>
